...
-- Extract from Salesforce to Azure SQL DB (Z_ADF_SFDC) for data comparison
...
--
delete
  from Z_ADF_SFDC.BATCH_PARAMETER
 where PROCESS_NAME = 'SFDC_TO_SQLDB_Z_ADF_SFDC_ADVISER';
 
--
-- The following entries are required to transfer data from Oracle (STAGE_CRM)
-- to Azure SQL DB (Z_ADF_SFDC) for data comparison
--
insert 
  into Z_ADF_SFDC.BATCH_PARAMETER
(
    PROCESS_NAME, 
    PARAMETER_NAME, 
...
values
(
    'SFDC_TO_SQLDB_Z_ADF_SFDC_ADVISER',
    'Account',
    'P',
